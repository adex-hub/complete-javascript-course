...
// If changes like daylight savings are needed within calculations libraries such as moment.js can be used.
console.log(days1);
*/
...
const pizzaTimer = setTimeout(
  (ing1, ing2) =>
    console.log(`Here is your pizza 🍕 containing ${ing1} and ${ing2}.`),
  3000,
  ...ingredients
);
